...
class _SignUpState extends State<SignUp> {
  ...
  TextEditingController useridEditingController = new TextEditingController();
  ...
  SignedUp() {
    if (newkey.currentState.validate()) {
      ...
      Map<String , String> userInfoMap = {
        "userName" : useridEditingController.text,
        "email" : emailEditingController.text
      };

      Help_func.saveUserEmailSharedPreference(useridEditingController.text);
      Help_func.saveUserEmailSharedPreference(emailEditingController.text);
      ...
      authSignIn
          ...
          .then((value) {
        //print("${value.uid}");
        dataBase.uploaduser_info(userInfoMap);
